...
vignette: >
  %\VignetteIndexEntry{Introdution to Goodreader Package}
...
Since **Goodreader** is available on [CRAN](https://CRAN.R-project.org/package=), you can install it by:
...
knitr::include_graphics('../vignettes/Topic1.png')
```

Topic 2:
```{r echo=FALSE, out.width='400px'}
knitr::include_graphics('../vignettes/Topic2.png')
```

Topic 3:
```{r echo=FALSE, out.width='400px'}
knitr::include_graphics('../vignettes/Topic3.png')
```

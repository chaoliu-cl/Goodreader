...
knitr::include_graphics('sentiment_hist.png')
```
...
```
```{r echo=FALSE, out.width='400px'}
knitr::include_graphics('sentiment_trend.png')
```
...
```
```{r echo=FALSE, out.width='400px'}
knitr::include_graphics('topic_terms.png')
```
...
Topic 1:
```{r echo=FALSE, out.width='400px'}
knitr::include_graphics('Topic1.png')
```

Topic 2:
```{r echo=FALSE, out.width='400px'}
knitr::include_graphics('Topic2.png')
```

Topic 3:
```{r echo=FALSE, out.width='400px'}
knitr::include_graphics('Topic3.png')
```
